...
- Output: the shared Publication adapter recovered Alice's title, Lewis Carroll as author, 19 reading-order resources, and 16 TOC entries. Phase 1 persists this normalized EPUB below the app-owned book directory.
